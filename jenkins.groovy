            ...
            script {
                if (branchName.equals("master") || branchName.equals("main")) {
                    publishHTML([allowMissing         : false,
                      ...
                      slackSend color: "#FF0000", message: " Build completed and  result:- ${env.JOB_NAME}/${env.BUILD_NUMBER} build started /${env.Build_URL} ......${currentBuild.result}.====="+output+"=========${env.currentResult}"
